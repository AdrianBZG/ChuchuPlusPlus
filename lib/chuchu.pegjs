...
block = d:(declaration)* st:st?{
          let declarations = [];
<<<<<<< b837c3f5619bc7a212b1cef658c80d7970d72136
=======

>>>>>>> Function declaration inside class declaration functional
...
functionDeclaration = FUNCTION id:ID LEFTPAR !COMMA p1:ID? r:(COMMA ID)* RIGHTPAR b:st SC {
              let params = p1? [p1] : [];
